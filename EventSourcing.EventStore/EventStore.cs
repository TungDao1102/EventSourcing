...
{
    public class EventStore(EventStoreConnectionFactory dbConnectionFactory, INotificationService notificationService) : IEventStore
    {
        ...
        public IEnumerable<StoredEvent> GetEvents(Guid aggregateId)
        {
            ...
            return connection.Query<DatabaseEvent>(query, new { AggregateId = aggregateId }).Select(e => e.ToStoredEvent());
        }
        ...
        public IEnumerable<StoredEvent> GetEventsUntilSequence(Guid aggregateId, int sequence)
        {
            ...
            return connection.Query<DatabaseEvent>(query, new { AggregateId = aggregateId, Sequence = sequence })
