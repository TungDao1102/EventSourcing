...
{
    public record AddBeerBottle(Guid BoxId, BeerBottle BeerBottle);

    public class AddBeerBottleHandler(IEventStore eventStore) : CommandHandler<AddBeerBottle>(eventStore)
    {
